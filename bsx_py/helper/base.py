...
class AccountManager(AccountInfo):
    ...
    @staticmethod
    def from_multi_sig(wallet_addr: str, signature: str, nonce: int, signer_secret: str, domain: str, domain_signature: EIP712Struct):
        from .multi_sign_base_manager import MultiSigBaseManager
        return MultiSigBaseManager(wallet_addr, signature, nonce, signer_secret, domain, domain_signature)
