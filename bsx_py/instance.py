...
class BSXInstance:
    ...
    @staticmethod
    def from_multi_sig_wallet(env: Environment | str, wallet_address: str, signature: str, nonce: int, signer: LocalAccount) -> 'BSXInstance':
        """
        ...
        instance._acc_manager = AccountManager.from_multi_sig(
            wallet_addr=wallet_address, signature=signature, nonce=nonce, signer_secret=signer.key, domain=domain,
