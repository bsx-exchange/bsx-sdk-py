...
def gen_register_typed_message_for_multisig_wallet(env: Environment | str, signer: LocalAccount, nonce: int) -> dict:
    """
    Helper function to generate the typed message that used to generate the signature for register a multisig wallet.
